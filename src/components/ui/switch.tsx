...
function Switch(
	...
	return (
		<SwitchPrimitive.Root
			...
			class={cn(
				'peer group/switch relative inline-flex shrink-0 items-center rounded-base border-2 px-[2px] transition-all outline-none after:absolute after:-inset-x-3 after:-inset-y-2 focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2 aria-invalid:border-destructive data-[size=default]:h-6 data-[size=default]:w-12 data-[size=sm]:h-5 data-[size=sm]:w-9 data-disabled:cursor-not-allowed data-disabled:opacity-50 cursor-pointer data-checked:bg-primary-soft data-checked:border-primary-strong data-unchecked:bg-secondary-soft data-unchecked:border-secondary-strong shadow-shadow active:translate-x-boxShadowX active:translate-y-boxShadowY active:shadow-none',
				local.class,
			)}
			{...rest}
		>
			<SwitchPrimitive.Thumb
				...
				class="pointer-events-none relative flex items-center justify-center group/thumb rounded-base border-2 bg-background dark:bg-primary-strong ring-0 transition-transform group-data-checked/switch:border-primary-strong group-data-unchecked/switch:border-secondary-strong group-data-[size=default]/switch:h-[18px] group-data-[size=default]/switch:w-5 group-data-[size=sm]/switch:h-3 group-data-[size=sm]/switch:w-4 data-checked:translate-x-[100%] data-unchecked:translate-x-0"
			>
